...
The repository includes a paired target/background EMULATED ADC test vector, immutable SHA-256 provenance, a Python verification pipeline, and an independent C++17 validator. Start with `ARTIFACT_EVALUATION.md`.
